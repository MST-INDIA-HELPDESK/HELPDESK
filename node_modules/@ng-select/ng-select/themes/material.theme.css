...
.ng-select-container .ng-value-container .ng-value{color:rgba(0,0,0,0.38)}
.ng-select.ng-select-disabled 
.ng-select-container .ng-value-container .ng-placeholder{color:rgba(0,0,0,0.38)}
...
.ng-select.ng-select-focused .ng-select-container:after{border-color:#ccc;border-width:0.5px}
...
.ng-select.ng-select-focused .ng-select-container .ng-arrow-wrapper .ng-arrow{color:#3f51b5}.ng-select .ng-has-value .ng-placeholder,.ng-select.ng-select-filtered .ng-select-container .ng-placeholder{display:initial}
.ng-select .ng-has-value .ng-placeholder,.ng-select.ng-select-opened .ng-placeholder{transform:translateY(-1.28125em) scale(0.75) perspective(100px) translateZ(0.001px)}.ng-select .ng-select-container{align-items:baseline;min-height:20px; min-width:auto;}
.ng-select .ng-select-container:after{border: 0.5px dotted #ccc; content:'';width:100%;bottom:0;position:absolute;transition:border-color 0.3s cubic-bezier(0.55, 0, 0.55, 0.2)}
.ng-select .ng-select-container .ng-value-container{align-items:baseline;padding:.2rem;border-top:0 solid transparent}
...
.ng-select.ng-select-multiple .ng-select-container .ng-value-container .ng-value{margin-right:0.4375em;margin-bottom:0.4375em;background-color:#3f51b5;border-radius:2px;color:#fff;padding:2px 5px}
...
.ng-select.ng-select-multiple .ng-select-container .ng-value-container .ng-value .ng-value-label{font-size:14px;font-weight:500}.ng-select.ng-select-multiple .ng-select-container .ng-value-container .ng-value .ng-value-icon{color:rgba(255,255,255,0.54);padding-right:5px}
...
.ng-select .ng-clear-wrapper{color:rgba(0,0,0,0.54)}.ng-select .ng-clear-wrapper:hover{color:rgba(0,0,0,0.87)}
.ng-select .ng-arrow-wrapper{bottom:2px}.ng-select .ng-arrow-wrapper .ng-arrow{border-left:5px solid transparent;border-right:5px solid transparent;border-top:5px solid;margin:0 4px;color:rgba(0,0,0,0.54)}.ng-select .ng-spinner-zone{top:3px}
.ng-dropdown-panel{background:#fff;width:unset !important;}
...
.ng-dropdown-panel.multiple .ng-option.selected{background:#fff}.ng-dropdown-panel.multiple .ng-option.marked{background:rgba(0,0,0,0.04)}
.ng-dropdown-panel .ng-dropdown-header{border-bottom:1px solid rgba(0,0,0,0.12);padding:2px;line-height:3em}
.ng-dropdown-panel .ng-dropdown-footer{border-top:1px solid rgba(0,0,0,0.12);padding:0 16px;line-height:3em;min-height:3em}
.ng-dropdown-panel .ng-dropdown-panel-items .ng-optgroup{user-select:none;cursor:pointer;line-height:3em;padding:0 16px;color:rgba(0,0,0,0.54);font-weight:500}
...
.ng-dropdown-panel .ng-dropdown-panel-items .ng-option{line-height:3em;min-height:3em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;padding:0 16px;text-align:left;text-decoration:none;position:relative;color:rgba(0,0,0,0.87)}
...
.plr-5 .ng-select-container .ng-value-container .ng-input>input{color: transparent;outline: none;cursor: unset;}
.ng-select .ng-select-container .ng-value-container .ng-placeholder {margin: -3px;font-weight: 500}